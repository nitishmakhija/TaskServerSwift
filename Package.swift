...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/AliSoftware/Dip.git", from: "6.0.0"),
    ...
    targets: [
        ...
        .target(name: "TaskerServerLib", dependencies: ["PerfectHTTPServer", "Dip", "Configuration", "PerfectSQLite", "PerfectCrypto", "FileKit", "Swiftgger", "PerfectCORS"]),
