...
class Users {
    public class func seed(databaseContext: DatabaseContext) throws {
        ...
        if administrator == nil {
            ...
            let user = User(id: UUID(), createDate: Date(), name: "Administrator", email: "admin@taskserver.com",
            ...
            try databaseContext.set(UserRole.self).insert(UserRole(id: UUID(), createDate: Date(), userId: user.id,
