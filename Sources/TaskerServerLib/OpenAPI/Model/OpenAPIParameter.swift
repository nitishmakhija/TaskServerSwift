...
class OpenAPIParameter: Encodable {
    ...
    init(name: String, parameterLocation: OpenAPIParameterLocation = OpenAPIParameterLocation.path, description: String? = nil, required: Bool = false, deprecated: Bool = false, allowEmptyValue: Bool = false) {
        self.name = name
